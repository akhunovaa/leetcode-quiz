...
public class Application extends  SimpleApplication implements ActionListener {
    ...
    public void simpleInitApp() {
        ...
        ((BulletAppState)bulletAppState).getPhysicsSpace().add(landscape);
        ((BulletAppState)bulletAppState).getPhysicsSpace().add(player);

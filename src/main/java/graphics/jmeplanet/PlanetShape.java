...
public class PlanetShape extends ConcaveShape {
    ...
    private Vector3f convert(javax.vecmath.Vector3f oldVec)
    {
    ...
    private void convert(javax.vecmath.Vector3f oldVec, Vector3f newVec)
    {
        newVec.x = oldVec.x;
        newVec.y = oldVec.y;
        newVec.z = oldVec.z;
    ...
    private javax.vecmath.Vector3f convert(Vector3f oldVec)
    {
    ...
    private void convert(Vector3f oldVec, javax.vecmath.Vector3f newVec)
    {
        newVec.x = oldVec.x;
        newVec.y = oldVec.y;
        newVec.z = oldVec.z;

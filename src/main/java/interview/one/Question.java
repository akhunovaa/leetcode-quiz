...
public class Question {
     ...
     * 1# System.out.println(java == stringBuilder);
     * 2# System.out.println(java.equals(stringBuilder))
     * 3# System.out.println(stringBuilder.equals(stringBuilderTwo))
     */
    public static void main(String[] args) {
        ...
        У #1 выведет, так как данное сравнение будет всегда false. Так как проверяеи
         ссылаются ли ссылки на одни и те же объекты HEAP.
        Но надо учесть что #1 String java = "java"; имеет ссылку на пул строк,
        а #2 имеет ссылк на HEAP регион в памяти JAVA.
